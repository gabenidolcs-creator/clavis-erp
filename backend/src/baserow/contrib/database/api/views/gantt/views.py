...
class GanttViewView(APIView):
    ...
    @extend_schema(
        ...
        operation_id="list_database_table_gantt_view_rows",
        description=(
            ...
            200: get_example_pagination_serializer_class(
                ...
                additional_fields={
                    "field_options": FieldOptionsField(
                        serializer_class=GanttViewFieldOptionsSerializer,
                        required=False,
                    ),
                    "row_metadata": get_example_multiple_rows_metadata_serializer(),
                },
                serializer_name="PaginationSerializerWithGanttViewFieldOptions",
            ),
    ...
    def get(
        ...
        """Lists the rows for the gantt view."""
        ...
        view = view_handler.get_view_as_user(
            ...
            view_id,
            GanttView,
            base_queryset=GanttView.objects.prefetch_related("viewsort_set"),
        )
        ...
        paginator = GanttLimitOffsetPagination()
...
class PublicGanttViewRowsView(APIView):
    permission_classes = (AllowAny,)
    ...
    @extend_schema(
        ...
        tags=["Database table gantt view"],
        operation_id="public_list_database_table_gantt_view_rows",
        description=(
            "Lists the requested rows of the view's table related to the provided "
            "`slug` if the gantt view is public."
        ...
        responses={
            200: get_example_pagination_serializer_class(
                ...
                serializer_name="PublicPaginationSerializerWithGanttViewFieldOptions",
            ),
            400: get_error_schema(
                [
                    "ERROR_USER_NOT_IN_GROUP",
            ...
            404: get_error_schema(
                ["ERROR_GANTT_DOES_NOT_EXIST", "ERROR_FIELD_DOES_NOT_EXIST"]
            ),
        },
    )
    @map_exceptions(
    ...
    def get(
        ...
        """
        Lists all the rows of a gantt view, paginated with
        GanttLimitOffsetPagination.
