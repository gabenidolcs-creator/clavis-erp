...
from .pagination import TimelineLimitOffsetPagination
...
class TimelineViewView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            ...
            404: get_error_schema(["ERROR_TIMELINE_DOES_NOT_EXIST"]),
        },
    )
    @map_exceptions(
        {
    ...
    def get(
        ...
        """Lists the rows for the timeline view."""
        ...
        view = view_handler.get_view_as_user(
            ...
            view_id,
            TimelineView,
            base_queryset=TimelineView.objects.prefetch_related("viewsort_set"),
        )
        ...
        paginator = TimelineLimitOffsetPagination()
...
class PublicTimelineViewRowsView(APIView):
    ...
    def get(
        ...
        """
        Lists all the rows of a timeline view, paginated with
        TimelineLimitOffsetPagination.
