...
from .pagination import KanbanLimitOffsetPagination
...
class KanbanViewView(APIView):
            ...
            200: get_example_pagination_serializer_class(
                ...
                additional_fields={
                    "field_options": FieldOptionsField(
                        serializer_class=KanbanViewFieldOptionsSerializer,
                        required=False,
                    ),
    ...
    def get(
        ...
        """Lists the rows for the kanban view."""
...
class PublicKanbanViewRowsView(APIView):
    permission_classes = (AllowAny,)
    ...
    @extend_schema(
        ...
        description=(
            "Lists the requested rows of the view's table related to the provided "
            "`slug` if the kanban view is public."
        ...
        responses={
            200: get_example_pagination_serializer_class(
                ...
                serializer_name="PublicPaginationSerializerWithKanbanViewFieldOptions",
            ),
            400: get_error_schema(
                [
                    "ERROR_USER_NOT_IN_GROUP",
    ...
    def get(
        ...
        """
        Lists all the rows of a kanban view, paginated with
        KanbanLimitOffsetPagination.
