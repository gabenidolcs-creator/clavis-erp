...
from .errors import ERROR_CALENDAR_DOES_NOT_EXIST
from .pagination import CalendarLimitOffsetPagination
...
class CalendarViewView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            200: get_example_pagination_serializer_class(
                ...
                additional_fields={
                    "field_options": FieldOptionsField(
                        serializer_class=CalendarViewFieldOptionsSerializer,
                        required=False,
                    ),
                    "row_metadata": get_example_multiple_rows_metadata_serializer(),
                },
                serializer_name="PaginationSerializerWithCalendarViewFieldOptions",
            ),
            ...
            404: get_error_schema(["ERROR_CALENDAR_DOES_NOT_EXIST"]),
        },
    )
    @map_exceptions(
        {
            UserNotInWorkspace: ERROR_USER_NOT_IN_GROUP,
            ViewDoesNotExist: ERROR_CALENDAR_DOES_NOT_EXIST,
    ...
    def get(
        ...
        """Lists the rows for the calendar view."""
        ...
        view = view_handler.get_view_as_user(
            ...
            view_id,
            CalendarView,
            base_queryset=CalendarView.objects.prefetch_related("viewsort_set"),
        )
        ...
        paginator = CalendarLimitOffsetPagination()
...
class PublicCalendarViewRowsView(APIView):
    permission_classes = (AllowAny,)
    ...
    @extend_schema(
        ...
        description=(
            "Lists the requested rows of the view's table related to the provided "
            "`slug` if the calendar view is public."
        ...
        responses={
            200: get_example_pagination_serializer_class(
                ...
                serializer_name=(
                    "PublicPaginationSerializerWithCalendarViewFieldOptions"
                ),
            ),
            400: get_error_schema(
                [
            ...
            404: get_error_schema(
                ["ERROR_CALENDAR_DOES_NOT_EXIST", "ERROR_FIELD_DOES_NOT_EXIST"]
            ),
        },
    )
    @map_exceptions(
    ...
    def get(
        ...
        """
        Lists all the rows of a calendar view, paginated with
        CalendarLimitOffsetPagination.
